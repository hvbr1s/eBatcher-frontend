                ...
                <div>
                  <div className="sunken-panel mb-2" style={{ padding: "6px" }}>
                    <p style={{ fontSize: "10px", margin: 0 }}>
                      <strong>Balance:</strong> <span style={{ fontFamily: "Courier New, monospace" }}>{eBatcher.decryptedBalance}</span>
                    </p>
                  </div>
                  <div className="field-row">
          ...
          <div className={`tab-content ${activeTab === "operator" ? "active" : ""}`}>
            <fieldset>
              ...
              {tokenAddress && address && eBatcher.operatorStatus[`${tokenAddress}-${address}`] !== undefined && (
                <div className={`info-box ${eBatcher.operatorStatus[`${tokenAddress}-${address}`] ? "success" : "warning"} mb-2`}>
                  <p style={{ fontWeight: "bold" }}>
                    {eBatcher.operatorStatus[`${tokenAddress}-${address}`] ? "✅ Operator Already Set" : "⚠️ Operator Not Set"}
                  </p>
                  ...
                  {eBatcher.message.split("\n").map((line, i) => {
                    ...
                    if (urlMatch) {
                      ...
                      return (
                        <div key={i}>
                          {parts[0]}
                          <a href={url} target="_blank" rel="noopener noreferrer" style={{ color: "#0000EE", textDecoration: "underline" }}>
                            {url}
                          </a>
                          {parts[1]}
                        </div>
